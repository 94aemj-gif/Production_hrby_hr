...
(function () {
  ...
  const DICT = {
    es: {
      ...
      "charts.subtitle": "Histórico por día",
      "admin.deviceSub": "Dispositivo",
      "admin.sn.general": "General",
      "admin.sn.data": "Datos",
      "admin.config.title": "Configuración",
      "admin.config.subtitle": "Dispositivo, parámetros, audio y seguridad.",
      "admin.catalogs.title": "Catálogos",
      "admin.catalogs.subtitle": "Líneas, turnos, operadores y motivos.",
      "admin.resumen.title": "Resumen",
      "admin.resumen.subtitle": "Historial de sesiones y bitácora.",
      "admin.datos.title": "Datos",
      "admin.datos.subtitle": "Sincronización y mantenimiento de datos locales.",
      "admin.newPwd.helper": "Mínimo 4 dígitos. Se aplica en este dispositivo.",
      "admin.data.note": "Operaciones destructivas. Úselas con cuidado.",
      "admin.demo.title": "Datos demo",
      "admin.demo.note": "Carga 14 días de datos simulados (3 líneas, 8 operadores, 2 turnos) para probar la interfaz.",
      "admin.demo.load": "Cargar datos demo",
      ...
      "dashboard.linesTitle": "Estado por línea",
      "dashboard.filter.all": "Todas",
      "dashboard.filter.active": "Activas",
      "dashboard.filter.idle": "En paro",
      "dashboard.h1": "Tablero de Producción",
      "dashboard.metaSuffix": "líneas configuradas · Actualizado en tiempo real",
      "btn.today": "Hoy",
      "btn.export": "Exportar",
    ...
    en: {
      ...
      "charts.subtitle": "Daily history",
      "admin.deviceSub": "Device",
      "admin.sn.general": "General",
      "admin.sn.data": "Data",
      "admin.config.title": "Settings",
      "admin.config.subtitle": "Device, parameters, audio, and security.",
      "admin.catalogs.title": "Catalogs",
      "admin.catalogs.subtitle": "Lines, shifts, operators, and reasons.",
      "admin.resumen.title": "Summary",
      "admin.resumen.subtitle": "Session history and movement log.",
      "admin.datos.title": "Data",
      "admin.datos.subtitle": "Sync and local data maintenance.",
      "admin.newPwd.helper": "Minimum 4 digits. Applies on this device.",
      "admin.data.note": "Destructive operations. Use with care.",
      "admin.demo.title": "Demo data",
      "admin.demo.note": "Loads 14 days of simulated data (3 lines, 8 operators, 2 shifts) to test the UI.",
      "admin.demo.load": "Load demo data",
      ...
      "dashboard.linesTitle": "Line status",
      "dashboard.filter.all": "All",
      "dashboard.filter.active": "Active",
      "dashboard.filter.idle": "Idle",
      "dashboard.h1": "Production Dashboard",
      "dashboard.metaSuffix": "lines configured · Live updates",
      "btn.today": "Today",
      "btn.export": "Export",
